...
urlpatterns = [
	...
	url(r'^pkn/design/new/$', views.pkn_design, name='pkn_design'),
	url(r'^pkn/design/results/(?P<pk>\d+)/$', views.pkn_design_results, name='pkn_design_results'),
	url(r'^pkn/designsim/(?P<pk>\d+)/remove/$', views.design_sim_remove, name='design_sim_remove'), 
	url(r'^pkn/designsim/(?P<pk>\d+)/save/$', views.design_sim_save, name='design_sim_save'), 
